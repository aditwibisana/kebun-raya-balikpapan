...
<body>
    ...
    <div class="nav-container">
        <ul class="nav">
            <li><a href="/pengunjung">Beranda </a>
            </li>
            <li><a href="/profile/{{auth()->user()->id}}/edit">Edit Profil </a>
            </li>
    ...
    <div id="wrapper" class="container-fluid smooth-transition">
        ...
        <header>
            <div class="container">
                <!-- Branding--><a href="index.html" class="brand"> <img alt="" src="images/kebun-raya-2.png" class="dark-brand" width="200px" height="50px"><img alt="" src="images/kebun-raya-2.png" class="light-brand" width="200px" height="50px"></a>
                <!-- Menu-->
                <div class="menu"></div>
            </div>
        </header>
                ...
                <li class="slide">
                    ...
                    <div class="hero fs">
                        ...
                        <div class="container text-center offset-top">
                            <!-- Content-->
                            <div class="content">
                                <h3 class="lg">Selamat Datang {{auth()->user()->name}}</h3>
                                <a href="/tempat" class="btn btn-default">Booking Tempat</a>
                            </div>
                        </div>
                    </div>
                </li>
